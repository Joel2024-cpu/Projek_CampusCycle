  ...
  <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-lg">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
      ...
      <div>
        ...
        <input type="text" name="name" required class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-600">
      </div>
      <div>
      ...
      <div>
        ...
        <input type="password" name="password_confirmation" required class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-600">
      </div>
    ...
    <p class="text-center text-gray-600 mt-4">
      Sudah punya akun?
      <a href="/login" class="text-green-700 font-semibold hover:underline">Login di sini</a>
    </p>
  </div>
</div>
@endsection
