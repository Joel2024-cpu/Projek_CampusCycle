    ...
    <div class="relative flex items-center justify-center min-h-screen w-full
        ...
        <div class="relative z-10 w-full max-w-md p-8 md:p-10
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email"
                               ...
                               oninvalid="this.setCustomValidity('Mohon isi alamat email Anda')"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password"
                               ...
                               oninvalid="this.setCustomValidity('Mohon isi kata sandi Anda')"
                               oninput="this.setCustomValidity('')">
                    </div>
                </div>
            ...
            <p class="text-sm font-light text-gray-600 text-center pt-4">
                Belum punya akun?
                <a href="{{ route('register') }}" class="font-medium text-[var(--primary)] hover:underline">
                    Daftar di sini
                </a>
            </p>
        </div>
